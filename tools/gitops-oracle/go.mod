module github.com/headmin/fleet-editor-extensions/tools/gitops-oracle
...
require (
	...
	github.com/fleetdm/fleet/v4 v4.89.2
...
// Pinned to the Fleet version the target SERVER runs, not to main.
// The oracle answers "does flint match the Fleet that will actually reject
// this config?" — linking main would validate against behavior the server
// does not have yet. Bump this deliberately when the server is upgraded;
// building against a newer tag is also how you pre-flight that upgrade.
